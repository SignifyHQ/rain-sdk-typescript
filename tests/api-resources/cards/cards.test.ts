...
describe('resource cards', () => {
  ...
  test.skip('update: request options and params are passed correctly', async () => {
    ...
    await expect(client.cards.update('182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e', {
    billing: {
    city: 'city',
    country: 'country',
    countryCode: 'xx',
  ...
  test.skip('retrieveSecrets: only required params', async () => {
    const responsePromise = client.cards.retrieveSecrets('182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e', { SessionId: 'x' });
    const rawResponse = await responsePromise.asResponse();
    expect(rawResponse).toBeInstanceOf(Response);
    const response = await responsePromise;
    expect(response).not.toBeInstanceOf(Response);
  ...
  test.skip('retrieveSecrets: required and optional params', async () => {
    const response = await client.cards.retrieveSecrets('182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e', { SessionId: 'x' });
  });
});
