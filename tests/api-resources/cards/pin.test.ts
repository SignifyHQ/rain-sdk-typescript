...
describe('resource pin', () => {
  ...
  test.skip('retrieve: only required params', async () => {
    const responsePromise = client.cards.pin.retrieve('182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e', { SessionId: 'x' });
  ...
  test.skip('retrieve: required and optional params', async () => {
    const response = await client.cards.pin.retrieve('182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e', { SessionId: 'x' });
  });
