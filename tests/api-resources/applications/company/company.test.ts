...
describe('resource company', () => {
  ...
  test.skip('update: request options and params are passed correctly', async () => {
    ...
    await expect(client.applications.company.update('182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e', {
    address: {
    city: 'city',
    country: 'country',
    countryCode: 'xx',
  ...
  test.skip('uploadDocument: only required params', async () => {
    const responsePromise = client.applications.company.uploadDocument('182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e', { document: await toFile(Buffer.from('Example data'), 'README.md') });
    const rawResponse = await responsePromise.asResponse();
    expect(rawResponse).toBeInstanceOf(Response);
    const response = await responsePromise;
    expect(response).not.toBeInstanceOf(Response);
  ...
  test.skip('uploadDocument: required and optional params', async () => {
    const response = await client.applications.company.uploadDocument('182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e', {
