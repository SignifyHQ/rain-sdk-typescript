import fs from 'fs';
import type { ResponseLike } from 'rain-hello-world/internal/to-file';
import { toFile } from 'rain-hello-world/core/uploads';
...
describe('missing File error message', () => {
  ...
  test('is thrown', async () => {
    const uploads = await import('rain-hello-world/core/uploads');
    await expect(
